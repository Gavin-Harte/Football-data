...
supabase_password = "hY+#3*4~3ej*PnT"        # temporary
...
# this function should make it easier to collect all the match urls on a page and run the process 

def get_urls(page):     # page is the url of the page with all the links       
    driver.get(page)
    time.sleep(3)
